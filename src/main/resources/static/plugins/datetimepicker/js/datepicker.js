            ...
            var ids = {},
                ...
                tpl = {
                    ...
                    head: [
                        ...
                        '<thead>',
                        '<tr>',
                        '<th colspan="7" class="picker-title"><a class="datepickerGoPrev" href="#"><span><%=prev%></span></a>',
                ...
                fill = function (el) {
                    ...
                    for (var i = 0; i < options.calendars; i++) {
                        ...
                        if (i == 0)
                            tblCal.addClass('datepickerFirstView');
                        if (i == options.calendars - 1)
                            tblCal.addClass('datepickerLastView');
                        ...
                        while (cnt < 42) {
                            ...
                            if (date.getDate() == 1) {
                                data.weeks[indic].days[indic2].classname.push('leftRadius');
                            }
                            if (date.getDate() == date.getMaxDays()) {
                                data.weeks[indic].days[indic2].classname.push('rightRadius');
                            }
                            ...
                            if (options.date && (!$.isArray(options.date) || options.date.length > 0)) {
                                if (options.mode != 'tworanges') {
                                    if (fromUser.selected || options.date == val || ($.isArray(options.date) && $.inArray(val, options.date.slice(0, 2)) > -1) || (options.mode == 'range' && val >= options.date[0] && val <= options.date[1])) {
                                        ...
                                        if (val == options.date[1] || (options.mode == 'range' && val == options.date[1] - 86399000)) {
                                            data.weeks[indic].days[indic2].classname.push('rightRadius');
                                        }
                                    }
                                } else {
                                    ...
                                    if ((val >= options.date[2] && val <= options.date[3]) || (val == options.date[2])) {
                                        ...
                                        if (val == options.date[2]) {
                                            data.weeks[indic].days[indic2].classname.push('leftRadius2');
                                        }
                                        if (val == options.date[3]) {
                                            data.weeks[indic].days[indic2].classname.push('rightRadius2');
                                        }
                                    }
                                }
                            }
...
//                                options.extraHeight = divs.get(0).offsetHeight + divs.get(0).offsetHeight;  // heights from top/bottom borders
//                                options.extraWidth = divs.get(1).offsetWidth + divs.get(1).offsetWidth;     // widths from left/right borders
//                            }
...
//                                            if (options.selectableDates != null && baseDate != null) {
...
//                                            if (options.selectableDates != null && endDate != null) {
//                                                if (tmpEnd.getTime() > moment(endDate).getTime()) {
...
//                                            }
                                    ...
                                    if (tblEl.eq(0).hasClass('datepickerViewDays')) {
                                        ...
                                        el.find('span').text(tmp.getMonthName(false) + " " + tmp.getFullYear());
                                    }
                                }
                        ...
                        if (!$(this).data('datepicker')) {
                            ...
                            for (var i = 0; i < options.calendars; i++) {
                                ...
                                html += tmpl(tpl.head.join(''), {
                                    prev: options.prev,
                                    next: options.next,
                                    day1: options.locale.daysMin2[(cnt++) % 7],
                                    day2: options.locale.daysMin2[(cnt++) % 7],
                                    day3: options.locale.daysMin2[(cnt++) % 7],
                                    day4: options.locale.daysMin2[(cnt++) % 7],
                                    day5: options.locale.daysMin2[(cnt++) % 7],
                                    day6: options.locale.daysMin2[(cnt++) % 7],
                                    day7: options.locale.daysMin2[(cnt++) % 7]
                                });
                            }
                            cal
